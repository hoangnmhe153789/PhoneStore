...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="AdminController">HE153789</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="AdminController?service=logout">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Manage Center</li>
                        </ol>
                        <div class="row">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="BillController?service=update&oid=<%=b.getoID()%>" onclick ="return confirm('are you sure')">Update</a></td>
                                            <td><a href="BillController?service=delete&oid=<%=b.getoID()%>">Delete</a></td>
                                        </tr>
                                        <%}%>                                  
                                    </tbody>
                                </table>
