...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-expand-xl navbar-dark bg-dark">
            <a href="#" class="navbar-brand"><i class="fa fa-cube"></i>Phone<b>Store</b></a>  		
                    ...
                    <a href="#" class="nav-item nav-link"><i class="fa fa-users"></i><span>Team</span></a>		
                            <c:choose>
                                <c:when test="${sessionScope.username !=null}">
                                    <a href="CartController" class="nav-item nav-link"><i class="fa fa-shopping-cart"></i><span>Cart</span></a>
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="ProfileController" class="dropdown-item"><i class="fa fa-user-o"></i> Profile</a>
                            ...
                            <a href="LoginController" class="nav-item nav-link"><i class="fa fa-sign-in"></i><span>Login</span></a>
                        </c:otherwise>
                    </c:choose>
                </div>
            </div>
