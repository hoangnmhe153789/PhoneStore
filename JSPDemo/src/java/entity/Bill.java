...
public class Bill {
    ...
    public Bill(String oID, String dateCreate, String cname, String cphone, String cAddress, double total, int status, int cid, Customer customer) {
        this.oID = oID;
    ...
    public String toString() {
        return "Bill{" + "oID=" + oID + ", dateCreate=" + dateCreate + ", cname=" + cname + ", cphone=" + cphone + ", cAddress=" + cAddress + ", total=" + total + ", status=" + status + ", cid=" + cid + ", customer=" + customer + '}';
    }
